...
| `/det` | خطة اختبار Duolingo English Test (للكبار) مع مركز مذاكرة شامل. يحتوي مفردات مترجمة و22 موضوعا وقطعا ونماذج كتابة وتحدث وقواعد ومؤقت تدريب. التقدم يُحفظ في المتصفح |
...
الموقع يخدم من فرع **`gh-pages`** (يحوي `index.html` و`det-study.js` و`.nojekyll`)، ويتولى
[`.github/workflows/pages.yml`](.github/workflows/pages.yml) مزامنته تلقائيًا من
`public/det.html` و`public/det-study.js` عند كل دفعة إلى `main` — فالتعديل في مكان واحد ينعكس على
