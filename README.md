...
| `/det` | خطة اختبار Duolingo English Test (للكبار) مع جدول متابعة واستراتيجيات الاختبار. مركز المذاكرة في صفحة مستقلة ومرتبة ويحتوي مفردات مترجمة و22 موضوعا وقطعا ونماذج كتابة وتحدث وقواعد ومؤقت تدريب. التقدم يُحفظ في المتصفح |
